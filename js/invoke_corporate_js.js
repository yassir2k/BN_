	...
	$('input#cpSubmitPartners').click(function()
									  {
										  ...
										  for(var i=0; i < temp; i++)
										  {
											 ...
											 if( $('select#cLga_'+String(i+1)).val() == "")
											 {
											 ...
											 if( $('input#cRC_'+String(i+1)).val() != "")
											 {
												 $('font#crcn_'+String(i+1)).css('color','#333');
												 $('font#crcn_'+String(i+1)).attr('title',"");
											 }
											 if( $('input#cName_'+String(i+1)).val() != "")
											 {
												 $('font#cn_'+String(i+1)).css('color','#333');
												 $('font#cn_'+String(i+1)).attr('title',"");
											 }
											 if( $('input#cRegDate_'+String(i+1)).val() != "")
											 {
												 $('font#crd_'+String(i+1)).css('color','#333');
												 $('font#crd_'+String(i+1)).attr('title',"");
											 }
											 if( $('select#cState_'+String(i+1)).val() != "")
											 {
												 $('font#csr_'+String(i+1)).css('color','#333');
												 $('font#csr_'+String(i+1)).attr('title',"");
											 }
											 if( $('select#cLga_'+String(i+1)).val() != "")
											 {
												 $('font#clgaor_'+String(i+1)).css('color','#333');
												 $('font#clgaor_'+String(i+1)).attr('title',"");
											 }
											 if( $('input#cTown_'+String(i+1)).val() != "")
											 {
												 $('font#ctor_'+String(i+1)).css('color','#333');
												 $('font#ctor_'+String(i+1)).attr('title',"");
											 }
											 if( $('input#cStreet_'+String(i+1)).val() != "")
											 {
												 $('font#csa_'+String(i+1)).css('color','#333');
												 $('font#csa_'+String(i+1)).attr('title',"");
											 }
										  }
										for(var i=0; i < temp; i++)
										{
										...
										||  ($('select#cLga_'+String(i+1)).val() == "") || ($('input#cTown_'+String(i+1)).val() == "")
				...
				+ "&c_"+String(i+1)+"="+$('input#cRegDate_'+String(i+1)).val() + "&d_"+String(i+1)+"="+$('select#cState_'+String(i+1)).val()
					+ "&e_"+String(i+1)+"="+$('select#cLga_'+String(i+1)).val() + "&f_"+String(i+1)+"="+$('input#cTown_'+String(i+1)).val()
					+ "&g_"+String(i+1)+"="+$('input#cStreet_'+String(i+1)).val() + "&h_"+String(i+1)+"="+$('input#id_'+String(i+1)).val();
											 }
								   ...
								   $.ajax(
										{
											   type: "POST",
											   url: "save_corporate_partners.php",
											   data: dat,
