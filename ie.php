...
<!------------------------------------------------------------------------------------------------------>
<td align="left">
<input type="text" id="availCode" style="width:200px;" maxlength="100" value="<?php echo $data[1]; ?>"/>
</td>
<td>Entry Number:
</td>
<td><input  disabled="disabled" type="text" value="<?php echo $data[0]; ?>" id="entryNo2" style="background-color:#f5f5f5;width:50px;" maxlength="100"/>
</td>
<!------------------------------------------------------------------------------------------------------>
</tr>
<!------------------------------------------------------------------------------------------------------>
...
<!------------------------------------------------------------------------------------------------------>
<td align="left">
<input type="text" id="receiptNo" style="width:200px;" maxlength="100" value="<?php echo $data[3]; ?>" />
</td>
<td><font id="os_font2">State Code</font>
</td>
<td><select id="stateCode" name="stateCode" style="width:180px;">
  <option value=""></option>
  <?php 
//sqlsrv_close($conn);
include("conn.php");
...
<!------------------------------------------------------------------------------------------------------>
<td align="left">
<input readonly="readonly" type="text" id="datePaid" name="datePaid" style="width:200px;" value="<?php echo $data[4]; ?>" />
</td>
<!------------------------------------------------------------------------------------------------------>
</tr>
<!------------------------------------------------------------------------------------------------------>
...
<!------------------------------------------------------------------------------------------------------>
<td align="left">
<input type="text" id="approvedName" style="width:400px;" maxlength="150" value="<?php echo $data[2]; ?>" />
</td>
</tr>
<!------------------------------------------------------------------------------------------------------>
<!------------------------------------------------------------------------------------------------------>
...
<!------------------------------------------------------------------------------------------------------>
<td align="left">
<input type="text" id="streetAddress" style="width:200px;" maxlength="100" value="<?php echo $data[6]; ?>" />
</td>
<!------------------------------------------------------------------------------------------------------>
</tr>
<!------------------------------------------------------------------------------------------------------>
...
<!------------------------------------------------------------------------------------------------------>
<td align="left">
<input type="text" id="town" style="width:200px;" maxlength="100" value="<?php echo $data[7]; ?>"/>
</td>
</tr>
<!------------------------------------------------------------------------------------------------------>
<!------------------------------------------------------------------------------------------------------>
...
<!------------------------------------------------------------------------------------------------------>
<td align="left">
    <select id="bnObject1" name="bnObject1" style="width:370px; font-family:cambria; font-size:12px;">
...
<!------------------------------------------------------------------------------------------------------>
<td align="left">
    <select id="bnObject2" name="bnObject2" style="width:370px; font-family:cambria; font-size:12px;">
    <option value=" ">Choose Object...</option>
<?php 
sqlsrv_close($conn);
include("conn.php");
...
<!------------------------------------------------------------------------------------------------------>
<td align="left">
    <select id="bnObject3" name="bnObject3" style="width:370px; font-family:cambria; font-size:12px;">
    <option value=" ">Choose Object...</option>
<?php 
sqlsrv_close($conn);
include("conn.php");
...
<input style="font-family:cambria; font-size:13px; color:#333333" type="button" id="submitBnForm" value="Save" />
<input style="font-family:cambria; font-size:13px; color:#333333" type="reset" id="resetBnEntries" value="Reset" />
</td>
</tr>
</table>
<br />
