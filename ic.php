...
<td align="left">
<input type="text" id="availCode_<?php echo $i+1;?>" style="background-color:#f5f5f5;width:200px;" value="<?php echo $avc;?>"/>
</td>
</tr>
<tr>
<td align="left"><font id ="crcn_<?php echo $i+1; ?>">Corporate RC Number</font></td>
<td align="left">
<input value="<?php echo $data[2]; ?>" type="text" id="cRC_<?php echo $i+1;?>" style="width:200px;" maxlength="100"/></td>
</tr>
<tr>
<td align="left"><font id ="cn_<?php echo $i+1; ?>">Corporate Name</font></td>
<td align="left">
<input value="<?php echo $data[3]; ?>" type="text" id="cName_<?php echo $i+1;?>" style="width:200px;" maxlength="100"/></td>
</tr>
<tr>
<td align="left"><font id ="crd_<?php echo $i+1; ?>">Corporate Registration Date</font></td>
<td align="left">
<input value="<?php echo $data[4]; ?>" type="text" id="cRegDate_<?php echo $i+1;?>" style="width:200px;" maxlength="100"/></td>
</tr>
</table>
</td>
...
<td align="left">
    ...
    <select id="cLga_<?php echo $i+1;?>" style="width:200px;">
    <option value=""></option>
<?php 
...
<td align="left">
<input value="<?php echo $data[7]; ?>" type="text" id="cTown_<?php echo $i+1;?>" style="width:200px;" maxlength="100"/></td>
</tr>
<tr>
<td align="left"><font id ="csa_<?php echo $i+1; ?>">Street Address</font></td>
<td align="left">
<input value="<?php echo $data[8]; ?>" type="text" id="cStreet_<?php echo $i+1;?>" style="width:200px;" maxlength="100"/></td>
</tr>
</table>
</td>
</tr>
...
{ ?>
<input id="cpSubmitPartners" value="Save" type="submit" style="font-family:cambria; font-size:13px; color:#333333" />
