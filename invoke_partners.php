...
<td align="left">
<input disabled="disabled" type="text" id="name_<?php echo $i+1;?>" style="width:200px;" maxlength="100" value="<?php echo $data[2];?>"/></td>
</tr>
<tr>
<td align="left"><font id ="fn_<?php echo $i+1; ?>">Former Name</font></td>
<td align="left">
<input disabled="disabled" type="text" id="fname_<?php echo $i+1;?>" style="width:200px;" maxlength="100" value="<?php echo $data[3];?>" /></td>
</tr>
<tr>
<td align="left"><font id ="ps_<?php echo $i+1; ?>">Partner's Sex</font></td>
<td align="left">
    <select disabled="disabled" id="sex_<?php echo $i+1; ?>" style="width:50px;">
    <option value=""></option>
    <?php if( $data[4] == "F")
	{?>
...
<td align="left">
<input disabled="disabled" type="text" id="occupation_<?php echo $i+1;?>" style="width:200px;" maxlength="100" value="<?php echo $data[5];?>" /></td>
</tr>
</table>
</td>
...
<td align="left">
    <select disabled="disabled" id="nationality_<?php echo $i+1; ?>" style="width:200px;">
    <option value=""></option>
<?php 
...
<td align="left">
    <select disabled="disabled" id="state_<?php echo $i+1;?>" style="width:200px;" onchange="getLgas(this.value,<?php echo $i+1;?>)">
    <option value=""></option>
<?php 
...
<td align="left">
    ...
    <select disabled="disabled" id="lga_<?php echo $i+1;?>" style="width:200px;">
    <option value=""></option>
	<?php 
...
<td align="left">
<input disabled="disabled" type="text" id="town_<?php echo $i+1;?>" style="width:200px;" maxlength="100" value="<?php echo $data[9];?>" /></td>
</tr>
<tr>
<td align="left"><font id ="sa_<?php echo $i+1; ?>">Street Address</font></td>
<td align="left">
<input disabled="disabled" type="text" id="street_<?php echo $i+1;?>" style="width:200px;" maxlength="100" value="<?php echo $data[10];?>" /></td>
</tr>
</table>
</td>
</tr>
...
<input id="blanket" name="blanket" value="Close Form" type="submit" />
<?php }?>
<div id="hoto"></div>
</div>
</center>
